...
class CollisionHandlingPhysics implements CollisionHandling {
  ...
  void handleCollision(GameItemMovable a, GameItemMovable b, PolygonCollisionResult collision) {
    ...
    if (a.hasCollided) {
      b.collisionCorrection.addToThis(a.collisionCorrection.x, a.collisionCorrection.y);
    } else {
    ...
    if (b.hasCollided) {
      a.collisionCorrection.addToThis(b.collisionCorrection.x, b.collisionCorrection.y);
    } else {
