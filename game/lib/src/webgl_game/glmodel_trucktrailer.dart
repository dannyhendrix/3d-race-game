...
class GlModel_TruckTrailer {
  ...
  GlModelInstanceCollection getModelInstance(GlModelCollection collection, GlColor colorBase, GlColor colorStripe, GlColor colorWindow) {
    ...
    GlMatrix wheelPositionLeft = GlMatrix.translationMatrix(-w.h + wWheelOffsetRear.v, hWheel.h + hWheelOffsetIn.v, d.h - dWheelOffsetIn.v).multThis(GlMatrix.rotationYMatrix(pi));
    GlMatrix wheelPositionLeft2 = GlMatrix.translationMatrix(-w.h + wWheelOffsetRear2.v, hWheel.h + hWheelOffsetIn.v, d.h - dWheelOffsetIn.v).multThis(GlMatrix.rotationYMatrix(pi));
