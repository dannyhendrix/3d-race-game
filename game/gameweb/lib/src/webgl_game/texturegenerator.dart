...
class TextureGenerator {
  ...
  List<List<int>> _constructReplaceColors(List<int> newColor1Ints, List<int> newColor2Ints) {
    return [newColor1Ints, _getColorIntsDark(newColor1Ints, 20), _getColorIntsDark(newColor1Ints, 40), newColor2Ints, _getColorIntsDark(newColor2Ints, 20), _getColorIntsDark(newColor2Ints, 40)];
  }
