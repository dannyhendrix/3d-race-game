...
import "package:gameweb/webgl_game.dart";
...
void main() {
  ...
  document.body.append(createSlider("offsetx", 0.0, 300.0, 1.0, preview.ox, (String val) {
    preview.ox = double.parse(val);
    preview.draw();
  }));
  document.body.append(createSlider("offsety", 0.0, 300.0, 1.0, preview.oy, (String val) {
    preview.oy = double.parse(val);
    preview.draw();
  }));
  document.body.append(createSlider("offsetz", 0.0, 900.0, 1.0, preview.oz, (String val) {
    preview.oz = double.parse(val);
    preview.draw();
  }));
  document.body.append(createSlider("rotatex", 0.0, 2 * Math.pi, 0.1, preview.rx, (String val) {
    preview.rx = double.parse(val);
    preview.draw();
  }));
  document.body.append(createSlider("rotatey", 0.0, 2 * Math.pi, 0.1, preview.ry, (String val) {
    preview.ry = double.parse(val);
    preview.draw();
  }));
  document.body.append(createSlider("rotatez", 0.0, 2 * Math.pi, 0.1, preview.rz, (String val) {
    preview.rz = double.parse(val);
    preview.draw();
  }));
...
*/
  document.body.append(createButton("Right side", () {
    applyView(preview, 0.0, 0.0, 0.0);
  }));
  document.body.append(createButton("Left side", () {
    applyView(preview, 0.0, Math.pi, 0.0);
  }));
  document.body.append(createButton("Front side", () {
    applyView(preview, 0.0, Math.pi * 0.5, 0.0);
  }));
  document.body.append(createButton("Rear side", () {
    applyView(preview, 0.0, Math.pi * 1.5, 0.0);
  }));
  document.body.append(createButton("Top", () {
    applyView(preview, Math.pi * 1.5, 0.0, 0.0);
  }));
  document.body.append(createButton("Bottom", () {
    applyView(preview, Math.pi * 0.5, 0.0, 0.0);
  }));
  document.body.append(createButton("Reset", () {
    applyView(preview, 1.0, 2.6, 5.8);
  }));
}
